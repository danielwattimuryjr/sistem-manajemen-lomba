...
<div class="certificate">
    ...
    <p class="description">
        ...
        <span class="placeholder">UPTD. Monumen Perjuangan Rakyat Bali</span> dari tanggal <span
                class="placeholder">{{ Carbon::parse($data->resource->competitionStartDate)->translatedFormat('l, d F Y') }}</span>
        s.d <span
                class="placeholder">{{ Carbon::parse($data->resource->competitionEndDate)->translatedFormat('l, d F Y') }}</span>
        bertempat di <span
                class="placeholder">...</span>.
    </p>
    <div class="bottom">
        <p>Denpasar, {{ Carbon::now()->isoFormat('D MMMM YYYY') }}</p>
        <p>Gubernur Bali,</p>
    </div>
</div>
</body>
